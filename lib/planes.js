...
// ============================================================
//
// IMPORTANTE: todos los precios son SIN IVA (se factura precio + 21%).
// Los clientes son empresas y se deducen el IVA, asi que su coste real es el
// precio de aqui: incluirlo solo significaba cobrar un 17% menos.
// Cualquier sitio que muestre estos importes debe indicar "+ IVA".
