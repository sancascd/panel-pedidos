...
// ============================================================
//
// IMPORTANTE (decision de Sandra, 2026-09-05):
//   - MENSUALIDADES (precio y overage): CON IVA INCLUIDO. De 99 EUR se
//     ingresan 81,82; el resto es el IVA que se liquida con Hacienda.
//   - IMPLEMENTACION (SETUP_FEE): SIN IVA, se factura 120 + 21%.
// Son criterios distintos a proposito. Cualquier sitio que muestre estos
// importes tiene que decir cual es cual.
