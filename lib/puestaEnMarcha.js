...
export const FASES = [
  {
    ...
    pasos: [
      ...
      { id: 'contratos', titulo: 'Los cuatro documentos impresos por duplicado',
        detalle: 'Contrato, Anexo I (servicio), Anexo II (protección de datos) y Anexo III (implementación).' },
