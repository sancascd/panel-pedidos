...
export const FASES = [
  {
    ...
    pasos: [
      ...
      { id: 'aviso-domicilio', titulo: 'Pedido mínimo y aviso de zonas de reparto, si tienen',
        detalle: 'Ajustes → Aviso para los repartos. El bot no sabe de zonas: si en un barrio no reparten '
          + 'o piden otro mínimo, va escrito ahí y el bot lo enseña antes de pedir la dirección.' },
  ...
  },
  {
    ...
    pasos: [
      ...
      { id: 'ficha-facturacion', titulo: 'Ficha de facturación creada',
        detalle: 'Admin → Facturación → Clientes: datos fiscales, importe, regla de precio si la tiene, '
          + 'cada cuánto y la fecha de la primera factura (el día de la puesta en marcha). Las facturas salen solas.',
        critico: true },
