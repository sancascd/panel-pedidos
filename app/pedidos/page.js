...
export default function PaginaPedidos() {
  ...
  // Referencia al elemento <audio> para el "ding"
  ...
  useEffect(() => {
    const canal = supabase
      ...
      .on(
        ...
        () => {
          // Reproducir sonido y recargar la lista
          if (audioRef.current) {
  ...
  async function cambiarEstado(pedido, nuevoEstado) {
    await supabase
      ...
      .eq('id', pedido.id);
    // El realtime detectará el UPDATE y refrescará solo
  ...
  return (
    <div className="min-h-screen">
      {/* Sonido del "ding" cuando llega un pedido */}
